...
#define ALOG_FATHEX(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_HEX ,LOGFAT , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_ERRHEX(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_HEX ,LOGERR , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_WANHEX(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_HEX ,LOGWAN , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_INFHEX(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_HEX ,LOGINF , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_ADTHEX(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_HEX ,LOGADT , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_DBGHEX(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_HEX ,LOGDBG , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )

#define ALOG_FATBIN(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_BIN ,LOGFAT , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_ERRBIN(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_BIN ,LOGERR , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_WANBIN(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_BIN ,LOGWAN , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_INFBIN(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_BIN ,LOGINF , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_ADTBIN(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_BIN ,LOGADT , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
#define ALOG_DBGBIN(regname,cstname,modname,buf,size)\
    alog_writelog_t( ALOG_TYPE_BIN ,LOGDBG , regname , cstname , modname , __FILE__ , __LINE__ , NULL , buf , size , NULL )
